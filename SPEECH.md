...
**Первое** — формулировка задачи должна содержать чёткий критерий приёмки. Иначе как понять, что задача решена? Каким образом агент должен понять, что работа завершилась успехом?
